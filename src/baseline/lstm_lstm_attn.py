...
class Attention(Module):
    ...
    def __init__(self, args):
        ...
        self.input_dim = args.encoder.hidden_dim*args.encoder.layers
        self.out_dim = 50
...
class TextToSql(Module):
    ...
    def forward(self, db_id, input_sequence, output_sequence = None):
        ...
        hidden_all , (hidden, cell) = self.encoder(input_sequence, lens)

        #need to generate input mask
        #context: [B, ISL, ENCOCDER_HIDDEN_DIM*ENCODER_LAYERS]
        #lens: [B x 1 x ENCOCDER_HIDDEN_DIM*ENCODER_LAYERS]
        (context, _) = pad_packed_sequence(hidden_all, batch_first = True)
