...
class CLEVRERVQADataset(Dataset):
    ...
    def __init__(
        ...
        if(self.split == 'train' or self.split == 'val' ):
            self.video_path = os.path.join(data_root, 'train', 'video')
        else:
            self.video_path = os.path.join(data_root, 'train', 'video')
    ...
    def get_questions(self):
        ...
        if(self.split == 'train' or self.split == 'val'):
            question_file = os.path.join(self.data_root, 'train','train.json')
        else:
            question_file = os.path.join(self.data_root,'test' ,'test.json')
