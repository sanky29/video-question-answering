...
class SlotFormerParams(BaseParams):
    ...
    data_root = '/home/textile/btech/tt1170896/scratch/COL775/A2/data'
    slots_root = '/home/textile/btech/tt1170896/scratch/COL775/A2/slotformer/data/clever_slots/slots.pkl'
    n_sample_frames = 6 + 10  # 6 burn-in, 10 rollout
    frame_offset = 2  # subsample the video by a factor of 2
    load_img = True
    filter_enter = False  # only train on valid sequences
    ...
    dec_dict = dict(
        ...
        dec_ks=5,
        dec_norm='',
        dec_ckp_path='/home/textile/btech/tt1170896/scratch/COL775/A2/slotformer/checkpoint/stosavi_clevrer_params/model_7.pth',
    )
