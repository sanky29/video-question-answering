...
from .module_3 import Contrastive
...
default_config = {
    ...
    "dataset":'BB_MMM_RGB',
    "dataset_roots": {
        "SINGLE_BALL_OUR":"../data/",
        "PONG":"../data/pong/",
        "GRAVITY": "../data/gravity",
        "MIX_LM_RY": "../../../scratch/project/baseline_models/STOVE_ORIG/data/MIX_LM_RY"
    },
    "train":{
        "rollout":1,
        "batch_size":64,
    ...
    "experiment_name": "encoder_bs_64",
    
    "checkpoint_every": 1,
    "validate_every":10,
    "long_rollout_every":100,
    "visualize_every": 10000,
    
    #"rollout_milestone":[(10,0),(20,1),(30,2),(40,3),(50,4),(60,5),(70,6),(80,7)],   #(epoch, rollout_till_then) 
    "rollout_milestone":[(1000,0),(70,4),(80,4)],   #(epoch, rollout_till_then) 
...
class ICSWM(BaseModel):
    ...
    def rollouter(self, past_slots, pred_len):
        input = dict()
        input['slots'] = past_slots
        results = self.model.generate(input, pred_len)
        return results['pred_slots']
