...
class SlotFormerParams(BaseParams):
    ...
    max_epochs = 100  # ~80k steps
    save_interval = 0.1  # save every 0.2 epoch
    ...
    # data settings
    dataset = 'icswm'
    data_root = '/home/textile/btech/tt1170896/scratch/data/BS_TTCC_MMMM_RGYC'
    ...
    # Slot Attention
    slot_dict = dict(
        num_slots=5,  # at most 5 objects per scene
        slot_size=128,
        slot_mlp_size=256,
        num_iterations=2,
    )
